package net.huray.omronsdk.ble.controller;
...
import net.huray.omronsdk.androidcorebluetooth.CBPeripheral;
...
import net.huray.omronsdk.ble.enumerate.OHQDataType;
import net.huray.omronsdk.ble.enumerate.OHQDetailedState;
...
import net.huray.omronsdk.utility.SynchronizeCallback;
import net.huray.omronsdk.utility.Types;
    ...
    private void _onDataReceived(@NonNull OHQDataType dataType, @NonNull Object data) {
        switch (dataType) {
            ...
            case DatabaseChangeIncrement:
                ...
                mListener.onDatabaseChangeIncrementUpdate(databaseChangeIncrement);
                break;
            case SequenceNumberOfLatestRecord:
                ...
                mListener.onSequenceNumberOfLatestRecordUpdate(sequenceNumberOfLatestRecord);
                break;
            case MeasurementRecords:
                ...
                mListener.onLastSessionInfoUpdate(mSessionData);
                break;
            default:
                break;
        }
